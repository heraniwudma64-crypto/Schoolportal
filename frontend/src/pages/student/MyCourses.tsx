          ...
          <div key={subject.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow">
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs text-gray-400">{subject.grade}</span>
              </div>
              ...
              <div className="mt-6 pt-6 border-t border-gray-100 flex gap-2">
                <button onClick={() => window.location.href = '/materials'} className="flex-1 py-2 bg-blue-50 text-blue-600 rounded-lg text-sm font-semibold hover:bg-blue-100 transition-colors">
                  Course Material
                </button>
                <button onClick={() => toast.info('Syllabus download will be available soon')} className="flex-1 py-2 bg-gray-50 text-gray-600 rounded-lg text-sm font-semibold hover:bg-gray-100 transition-colors flex items-center justify-center gap-1">
