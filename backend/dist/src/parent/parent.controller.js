...
let ParentController = class ParentController {
    ...
    async getMyChildData(req, studentUserId) {
        const parentUserId = req.user.userId;
        return this.parentService.verifyAndGetChild(parentUserId, studentUserId);
    }
};
exports.ParentController = ParentController;
__decorate([
    (0, roles_decorator_1.Roles)('PARENT'),
    (0, common_1.Get)('child/:studentUserId'),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('studentUserId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], ParentController.prototype, "getMyChildData", null);
